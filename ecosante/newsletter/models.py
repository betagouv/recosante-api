    ...
    def attributes(self):
        ...
        return {
            **{
                ...
                "VIGILANCE_VALIDITE_DEBUT": self.vigilance_globale.validity.lower if self.vigilance_globale else "",
                "VIGILANCE_VALIDITE_FIN": self.vigilance_globale.validity.upper if self.vigilance_globale else "",
