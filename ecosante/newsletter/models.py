...
class NewsletterDB(db.Model, Newsletter):
    ...
    def __init__(self, newsletter: Newsletter):
        ...
        self.lien_aasqa = newsletter.inscription.commune.departement.region.aasqa_website,
        self.nom_aasqa = newsletter.inscription.commune.departement.region.aasqa_nom,
